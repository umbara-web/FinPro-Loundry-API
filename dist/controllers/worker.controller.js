...
exports.getWorkerHistory = exports.requestBypass = exports.processTask = exports.claimTask = exports.getStationTasks = void 0;
...
const requestBypass = async (req, res, next) => {
    ...
    try {
        ...
        if (!userId)
            throw new Error("Unauthorized");
        const result = await (0, worker_service_1.requestBypassService)(taskId, reason, userId);
        res.status(200).send(result);
    }
    catch (error) {
        next(error);
...
const getWorkerHistory = async (req, res, next) => {
    ...
    try {
        ...
        const result = await (0, worker_service_1.getWorkerHistoryService)(workerId, page, limit);
        res.status(200).send(result);
    }
    catch (error) {
        next(error);
