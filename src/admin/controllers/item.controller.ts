...
export const createItem = async (req: Request, res: Response) => {
    try {
        ...
        // Simple helper to map category string to Enum
        ...
        const data = {
            ...
            // If we want to store the "ITM-XXX" id from frontend as customId or id
            // Prisma `id` is CUID by default. Let's start with auto CUID for ID.
            // If we really want to keep ITM-XXX, we should pass it as `id` if the schema supports it being set manually.
...
export const updateItem = async (req: Request, res: Response) => {
    try {
        const rawData = req.body;
        // Need mapping logic similar to create if fields are updated

        // Helper mapping (reuse or refactor later)
